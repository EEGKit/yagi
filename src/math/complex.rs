// Rather than redefining these functions, we can use the ones from num_complex
// Confirm that they produce the same results as the C version by reusing the tests
